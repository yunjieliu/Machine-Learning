...
def CNN(input_var):
    ...
    Conv2=lasagne.layers.Conv2DLayer(Lrn1,num_filters=16, filter_size=(5, 5), stride=(1, 1), pad=0, \
    ...
    Full1=lasagne.layers.DenseLayer(Lrn2,num_units=400,nonlinearity=lasagne.nonlinearities.rectify,name='full1')
